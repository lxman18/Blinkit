...
//                                          System.out.println("Last 7 Characters Before '*': " + last7Chars);
                      ...
                      while (true) {
                    	  ...
                    	  innerEx.printStackTrace(); // Optional: log this
                    	  }
                    	  }

                    	  // After attempt, check if productlist is still present
                    	  try {
                    	  Thread.sleep(2000); // small wait to allow page update, adjust as needed
                    	  driver.findElement(By.xpath("/html/body/form/section[1]/section[5]/div[3]/div/div[6]/div"));
                    	  // If no exception thrown, element is present – repeat loop
                    	  } catch (NoSuchElementException e) {
