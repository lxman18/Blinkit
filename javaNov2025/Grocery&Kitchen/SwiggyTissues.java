...
public class SwiggyTissues {
    ...
    static class Product {
        ...
        String offer;
        String url;
        String GroceryanKitchen = "Grocery and Kitchen";
        String freshveg = "Fresh Vegetables";
        String freshvegtables = "Fresh Vegetables";

        Product(String name, String mrp, String sp, String uom, int availability, String offer, String url) {
        	this.url = url;
            this.name = name;
            this.mrp = mrp;
            this.sp = sp;
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            searchInput.sendKeys("Leafy and Seasonings");
            ...
            for (int j = 0; j < count; j++) {
                ...
                // Add product to list
                productList.add(new Product(name, mrp, sp, uom, availability, offer,url));
    ...
    private static void writeToExcel(List<Product> productList) {
        ...
        for (int i = 0; i < productList.size(); i++) {
            ...
            row.createCell(0).setCellValue(product.GroceryanKitchen);
            row.createCell(1).setCellValue(product.freshveg);
            row.createCell(2).setCellValue(product.freshvegtables);
        ...
        try (FileOutputStream fileOut = new FileOutputStream(".\\Output\\Leafy and Seasonings"+timestamp+".xlsx")) {
