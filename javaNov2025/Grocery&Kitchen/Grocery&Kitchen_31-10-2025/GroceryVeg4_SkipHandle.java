...
public class GroceryVeg4 {
    ...
    static class Product {
        ...
        String offer;
        String url;
        String l1 = "Household & Lifestyle";
        String l2 = "Cleaning Essentials";
        String l3;
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            wait.until(ExpectedConditions.elementToBeClickable(
                    By.xpath("(//div[@class='sc-gEvEer hoZLsh _3XNbf']/following::div[contains(., 'Cleaning Essentials')])[5]"))).click();
            Thread.sleep(5000);
            ...
            // Subcategories to skip (already scraped)
            List<String> skipSubcategories = Arrays.asList(
                "Top Deals",
                "Detergent Powders & Bars",
                "Detergent Liquids",
                "Fabric softeners & Other additives"
            );
            ...
            for (int i = 0; i < subcategories.size(); i++) {
                try {
                    ...
                    // Skip if this subcategory is already scraped
                    if (skipSubcategories.contains(subCatName)) {
                        System.out.println("Skipping already scraped subcategory: " + subCatName);
                        continue;
                    }
    ...
    private static void writeToExcel(List<Product> productList) {
        ...
        try (FileOutputStream fileOut = new FileOutputStream(".\\Output\\Household & Lifestyle_Cleaning Essentials11_"+timestamp+".xlsx")) {
